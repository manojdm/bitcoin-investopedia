...
const Terms = () => {
  ...
  <div className="header">
    <div className="container">
      <p className="title">Terms and Conditions for Bitcoin Investopedia</p>
    </div>
  </div>
      ...
      <div className="tab-content translations-content-item en visible" id="en">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Bitcoin
              Investopedia.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Bitcoin Investopedia,
              accessible from{" "}
              <a
                href="http://bitcoinvestopedia.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://bitcoinvestopedia.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            By email:{" "}
            <a
              href="mailto:btcinvestopedia@gmail.com"
              className="__cf_email__"
            >
              btcinvestopedia@gmail.com
            </a>
          </li>
        </ul>
      </div>
